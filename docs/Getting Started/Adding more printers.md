...
<figure markdown="span">
  ![Welcome pages](../Images/getting-started/add-printer-roll-down.png){ width="600" }
...
<figure markdown="span">
  ![Welcome pages](../Images/getting-started/add-felix-printer-2.png){ width="600" }
...
<figure markdown="span">
  ![Welcome pages](../Images/getting-started/network-vs-non-network-2.png){ width="600" }
...
<figure markdown="span">
  ![Welcome pages](../Images/getting-started/change-printers.gif){ width="600" }
